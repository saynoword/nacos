...
const I18N_CONF = {
  ...
  PromptManagement: {
    ...
    submitFailed: '提交审核失败',
    forcePublishSuccess: '强制发布成功',
    createDraftSuccess: '草稿创建成功',
    createDraftFailed: '草稿创建失败',
    updateDraftSuccess: '草稿保存成功',
    updateDraftFailed: '草稿保存失败',
    deleteDraftSuccess: '草稿删除成功',
    deleteDraftFailed: '草稿删除失败',
    onlineSuccess: '上线成功',
    onlineFailed: '上线失败',
    offlineSuccess: '下线成功',
    offlineFailed: '下线失败',
    labelsUpdateSuccess: '标签更新成功',
    descriptionUpdateSuccess: '描述更新成功',
    bizTagsUpdateSuccess: '业务标签更新成功',
    // Governance
    onlineCnt: '在线版本数',
    editingVersionLabel: '草稿',
    ...
    versionList: '版本列表',
    manageLabels: '管理 Labels',
    customLabels: '自定义 Labels',
    newLabel: '新 Label',
    updateLatestLabel: '更新 latest 标签',
    deleteDraftConfirm: '确定要删除当前草稿吗？',
    publishConfirm: '确定要发布版本 {0} 吗？',
    forcePublishConfirm: '确定要强制发布版本 {0} 吗？此操作将跳过 Pipeline 审核。',
    createDraftFromVersionDisabled: '已存在编辑中或审核中的版本',
    bizTags: '业务标签',
    bizTagsPlaceholder: '输入标签后按回车添加',
    versionLabels: '版本标签',
    noLabels: '暂无标签',
    author: '发布者',
    status: '状态',
    targetVersion: '目标版本号',
    targetVersionPlaceholder: '可选，例如: 1.0.1',
    aiOptimize: 'AI 优化',
    view: '查看',
    defaultValue: '默认值',
    defaultValuePlaceholder: '输入默认值',
    variableDesc: '描述',
    variableDescPlaceholder: '输入变量描述',
  },
  SkillManagement: {
    ...
    onlineCnt: '在线版本',
    editingVersion: '草稿版本',
    reviewingVersion: '审核版本',
    // Draft operations
    createDraft: '创建草稿',
    editDraft: '编辑草稿',
    deleteDraft: '删除草稿',
    deleteDraftConfirm: '确定要删除当前草稿吗？删除后将无法恢复。',
    createDraftSuccess: '草稿创建成功',
    createDraftFailed: '草稿创建失败',
    deleteDraftSuccess: '草稿删除成功',
    deleteDraftFailed: '草稿删除失败',
    updateDraftSuccess: '草稿更新成功',
    updateDraftFailed: '草稿更新失败',
    basedOnVersion: '基于版本',
    createDraftFromVersion: '基于此版本创建草稿',
    // Submit & Publish
    submitForReview: '提交审核',
    ...
    publishSuccess: '发布成功',
    publishFailed: '发布失败',
    updateLatestLabel: '同时更新 latest 标签',
    publishNotApproved: 'Pipeline 未通过，无法发布',
    publishConfirm: '确定要发布版本 {0} 吗？',
    // Online/Offline
    online: '上线',
    offline: '下线',
    ...
    manageLabels: '管理标签',
    labels: '标签',
    labelRequired: '请输入标签名',
    labelInvalid: '标签仅支持字母、数字、.-_',
    labelExists: '标签已存在',
    bindLabelSuccess: '标签更新成功',
    bindLabelFailed: '标签更新失败',
    newLabel: '新标签',
    customLabels: '自定义标签',
    // Pipeline
