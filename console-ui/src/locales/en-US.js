...
const I18N_CONF = {
  ...
  MainLayout: {
    ...
    promptRegistryComingSoon: 'Prompt Registry is coming soon...',
  ...
  PluginManagement: {
    ...
    'datasource-dialect': 'Datasource Plugin',
    'config-change': 'Config Change Plugin',
  ...
  SettingCenter: {
    ...
    settingSubmit: 'Apply',
    copilotConfigSection: 'Copilot Configuration',
    copilotConfigTitle: 'Nacos Copilot Configuration',
    copilotEnabled: 'Enable Copilot',
    copilotDefaultNamespace: 'Default Namespace',
    copilotLlmConfig: 'LLM Configuration',
    copilotLlmProvider: 'LLM Provider',
    copilotLlmApiKey: 'API Key',
    copilotLlmApiKeyPlaceholder:
      'Please enter API Key (recommended to set via environment variable)',
    copilotLlmApiKeyHint: 'Recommended to set via environment variable COPILOT_API_KEY',
    copilotLlmEndpoint: 'API Endpoint',
    copilotLlmEndpointPlaceholder: 'Please enter API Endpoint',
    copilotLlmModelName: 'Model Name',
    copilotLlmTemperature: 'Temperature',
    copilotLlmMaxTokens: 'Max Tokens',
    copilotStreamConfig: 'Stream Configuration',
    copilotStreamEnabled: 'Enable Stream Response',
    copilotStreamChunkSize: 'Chunk Size',
    copilotRetryConfig: 'Retry Configuration',
    copilotRetryMaxAttempts: 'Max Retry Attempts',
    copilotRetryBackoffMs: 'Retry Backoff (ms)',
    copilotTimeoutConfig: 'Timeout Configuration',
    copilotTimeoutConnectMs: 'Connect Timeout (ms)',
    copilotTimeoutReadMs: 'Read Timeout (ms)',
    copilotConfigSave: 'Save Configuration',
    copilotConfigSaving: 'Saving...',
    copilotConfigSaveSuccess: 'Save successful',
    copilotConfigSaveFailed: 'Failed to save configuration',
    copilotConfigLoadFailed: 'Failed to load configuration',
  },
  AgentManagement: {
    agentManagement: 'Agent Management',
  ...
  PromptManagement: {
    ...
    promptKeyRequired: 'Please enter Prompt Key',
    promptKeyPattern: 'Only letters, numbers, underscores and hyphens are allowed',
    description: 'Description',
    descriptionPlaceholder: 'Please enter description',
    version: 'Version',
    versionPlaceholder: 'e.g. 1.0.0',
    versionRequired: 'Please enter version',
    versionHelp: 'Format: major.minor.patch, e.g. 1.0.0, 2.1.3',
    versionFormatError: 'Invalid version format, please use x.y.z format',
    ...
    deleteConfirm: 'Delete Confirmation',
    deletePromptConfirm: 'Are you sure you want to delete Prompt "{0}"?',
    deleteSuccess: 'Delete successful',
    deleteFailed: 'Delete failed',
    getPromptListFailed: 'Failed to get Prompt list',
    noPromptData: 'No Prompt data',
    updateDescSuccess: 'Description updated successfully',
    updateDescFailed: 'Failed to update description',
    // NewPrompt page
    commitMsgPlaceholder: 'Please enter commit message (optional)',
    templateContent: 'Template Content',
    templateHelp: 'Example: Please answer the question: {{question}}, context: {{context}}',
    templateRequired: 'Please enter Prompt template content',
    templateVariables: 'Template Variables',
    noVariables: 'No template variables',
    variablesHint: 'Use {{variableName}} format to define template variables, e.g. {{question}}',
    create: 'Create',
    cancel: 'Cancel',
    save: 'Save',
    createSuccess: 'Created successfully',
    ...
    templatePlaceholder: 'Enter prompt template content...',
    publishNewVersion: 'Publish New Version',
    commitMsg: 'Commit Message',
    publishTime: 'Publish Time',
    latestVersion: 'Latest',
    historyVersion: 'History',
    templateEditHint: 'Edit template here, click "Publish New Version" to save changes',
    ...
    createDraftFromVersion: 'Create Draft From This',
    ...
    forcePublishSuccess: 'Force published successfully',
    createDraftSuccess: 'Draft created',
    createDraftFailed: 'Failed to create draft',
    updateDraftSuccess: 'Draft saved',
    updateDraftFailed: 'Failed to save draft',
    deleteDraftSuccess: 'Draft deleted',
    deleteDraftFailed: 'Failed to delete draft',
    onlineSuccess: 'Version is now online',
    onlineFailed: 'Failed to bring online',
    offlineSuccess: 'Version is now offline',
    offlineFailed: 'Failed to take offline',
    labelsUpdateSuccess: 'Labels updated',
    descriptionUpdateSuccess: 'Description updated',
    bizTagsUpdateSuccess: 'Biz tags updated',
    // Governance
    onlineCnt: 'Online Versions',
    editingVersionLabel: 'Draft',
    pipelineStatus: 'Review Pipeline',
    pipelineApproved: 'Approved',
    pipelineRejected: 'Rejected',
    pipelinePending: 'In Progress',
    ...
    forcePublishConfirm:
      'Are you sure you want to force publish version {0}? This will bypass pipeline review.',
    createDraftFromVersionDisabled: 'An editing or reviewing version already exists',
    bizTags: 'Biz Tags',
    bizTagsPlaceholder: 'Type and press Enter to add tags',
    versionLabels: 'Version Labels',
    noLabels: 'No labels',
    author: 'Author',
    status: 'Status',
    targetVersion: 'Target Version',
    targetVersionPlaceholder: 'Optional, e.g. 1.0.1',
    aiOptimize: 'AI Optimize',
    view: 'View',
    defaultValue: 'Default',
    defaultValuePlaceholder: 'Enter default value',
    variableDesc: 'Description',
    variableDescPlaceholder: 'Enter variable description',
  },
  SkillManagement: {
    ...
    delete: 'Delete',
    deleteConfirm: 'Delete Confirmation',
    deleteSkillConfirm: 'Are you sure you want to delete Skill "{0}"?',
    batchDeleteConfirm: 'Batch Delete Confirmation',
    batchDeleteContent: 'Are you sure you want to delete the following {0} Skills?',
    deleteSuccess: 'Delete successful',
    deleteFailed: 'Delete failed',
    batchDeleteSuccess: 'Batch delete successful',
    batchDeleteFailed: 'Batch delete failed',
    getSkillListFailed: 'Failed to get Skill list',
    noSkillData: 'No Skill data',
    selectSkillToDelete: 'Please select Skills to delete first',
    tip: 'Tip',
    updateTime: 'Update Time',
    operation: 'Operation',
    description: 'Description',
    ...
    create: 'Create',
    cancel: 'Cancel',
    skillNamePlaceholder: 'Please enter Skill name (letters, underscore, hyphen only)',
    skillNameInvalidChars: 'Name can only contain English letters, underscore and hyphen',
    skillNameNoDoubleUnderscore: 'Name cannot contain double underscores (__)',
    descriptionPlaceholder: 'Please enter Skill description',
    instructionPlaceholder: 'Please enter Skill instruction',
    resourceNamePlaceholder: 'Letters, numbers, dots, underscores, hyphens',
    resourceTypePlaceholder: 'Letters, hyphens, dots only',
    resourceContentPlaceholder: 'Enter resource content',
    requiredField: 'This field is required',
    createSuccess: 'Create successful',
    updateSuccess: 'Update successful',
    createFailed: 'Create failed',
    updateFailed: 'Update failed',
    getSkillInfoFailed: 'Failed to get Skill information',
    skillDetail: 'Skill Detail',
    basicInfo: 'Basic Information',
    viewJson: 'View JSON',
    skillNotFound: 'Skill not found',
    aiOptimize: 'AI Optimize',
    optimizationItems: 'Optimization Items',
    optimizeSuccess: 'Optimization applied successfully',
    optimizeFailed: 'Failed to apply optimization',
    optimizing: 'Optimizing...',
    optimize: 'Start Optimization',
    apply: 'Apply',
    noOptimizedSkill: 'No optimized skill data',
    ...
    optimizedSkillLoaded: 'Optimized skill data loaded successfully',
    applyGeneratedSkillHint: 'Click "Apply" to fill the form with the generated Skill',
    applyOptimizedSkillHint: 'Click "Apply" to fill the form with the optimized Skill',
    newResources: 'new',
    removed: 'removed',
    thinking: 'Thinking',
    thinkingProcess: 'Optimization reasoning process',
    changed: 'Changed',
    aiGenerate: 'AI Generate Skill',
    ...
    backgroundInfoRequired: 'Please enter background information',
    selectMcpTools: 'Select MCP Tools (Optional)',
    selectMcpServer: 'Select MCP Server',
    noToolsAvailable: 'No tools available in this MCP server',
    preview: 'Preview',
    previewSkill: 'Preview Skill',
    previewHint: 'This is the standard Skill format that will be saved:',
    close: 'Close',
    noPreviewData: 'No preview data available',
    fileStructure: 'File Structure',
    selectFileToPreview: 'Select a file to preview',
    noContent: 'No content',
    conversationHistory: 'Conversation History (Optional)',
    showConversationHistory: 'Show Conversation History',
    hideConversationHistory: 'Hide Conversation History',
    conversationHistoryPlaceholder:
      'Enter conversation history in JSON format:\n{\n  "title": "Conversation Title",\n  "context": "Context description",\n  "messages": [\n    {\n      "type": "user",\n      "content": "User input"\n    },\n    {\n      "type": "tool_call",\n      "toolName": "tool_name",\n      "toolInput": {"param": "value"},\n      "toolOutput": "result"\n    },\n    {\n      "type": "model",\n      "content": "Model response"\n    }\n  ]\n}',
    conversationHistoryHint:
      'The system will analyze the conversation history to determine if it is suitable for skill generation/optimization. Include user inputs, tool calls, and model responses.',
    conversationHistoryInvalid: 'Invalid conversation history JSON format',
    export: 'Download',
    ...
    onlineCnt: 'Online Versions',
    editingVersion: 'Draft Version',
    reviewingVersion: 'Reviewing Version',
    // Draft operations
    createDraft: 'Create Draft',
    editDraft: 'Edit Draft',
    deleteDraft: 'Delete Draft',
    deleteDraftConfirm:
      'Are you sure you want to delete the current draft? This action cannot be undone.',
    ...
    updateDraftFailed: 'Failed to update draft',
